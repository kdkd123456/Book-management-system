...
<nav class="breadcrumb">
  ...
  <a class="breadcrumb-item" href="#">创建图书</a>
  <a href="booksList" class="ml-auto font-weight-bold">返回图书管理</a>
</nav>


<form class="text-center" action="createBook" method="get">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="bname" id="bname" placeholder="书名">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="bprice" id="bprice" placeholder="保留两位小数">
      <div class="valid-feedback">
        完成！
      </div>
      <div class="invalid-feedback">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" id="bpublishdate" name="bpublishdate" class="form-control"
             onfocus="WdatePicker({})" placeholder="请选择出版日期"  />
      <div class="valid-feedback">
        完成！
      </div>
      <div class="invalid-feedback">
